<template>
  <div>
      ...
      <el-card class="box-card">
        <div>
          <p>Здесь представлена некоторая <b>часть</b> моих работ. Это не весь мой опыт. Остальное либо утеряно, либо является частью веб-проектов и не поддается демонстрации. Также сюда не добавлены неитересные проекты, такие как сайты на WordPress, типовые лендинги и т.п. </p>
          <p>Все эти проекты являются <b>реальными задачами</b> , и никакой из них не был реализован в учебных или демонстрационных целях. Те проекты, у которых есть ссылка на сайт, могли существенно видоизмениться без моего участия. Эти ссылки даны здесь лишь для подтверждения того, что данные разработки были использованы на реальных веб-проектах. Актуальный на момент разработки вариант по ссылке "Демо".</p>
