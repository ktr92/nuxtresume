<template>
  <div>
      ...
      <el-card class="box-card">
        <div>
          <p>Здесь представлена некоторая часть моих работ. Это не весь мой опыт, а лишь некоторая часть. Остальное либо утеряно, либо является частью вебпроекта и не поддается демонстрации. Также сюда не добавлены неитересные проекты, такие как сайты на WordPress, типовые лендинги и т.п. </p>
          <p>Все эти проекты являются реальными задачами, и никакой из них не был реализован в учебных или демонстрационных целях. Те проекты, у которых есть ссылка на сайт, могли серьезно видоизмениться без моего участия. Эти ссылки даны здесь лишь для подтверждения того, что данные разработки были использованы на реальных веб-проектах.</p>
