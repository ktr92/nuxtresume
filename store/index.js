export const state = () => ({
  ...
  description: 'Опыт адаптивной кроссбраузерной верстки сайтов более 6 лет. Опыт Frontend разработки VueJS и NuxtJS небольшой, но это направление, в котором я активно развиваюсь. Занимаюсь улучшением знаний английского языка. Имею опыт работы как в команде, так и удаленно.',
  skills: [
